...
export default function NavBar() {
    ...
    return (
        <>
            <Menu changeShowMenu={changeShowMenu} isShowMenu={isShowMenu} />
            <Overlay changeShowMenu={changeShowMenu} isShowMenu={isShowMenu} />
            <div className='py-4 md:py-5 bg-white sticky top-0 shadow-sm z-30'>
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div>
                            ...
                            <div className="block md:hidden">
                                <span className='cursor-pointer' onClick={showMenuHandler}>
